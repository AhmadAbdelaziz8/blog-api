...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 container mx-auto p-4 animate-fadeIn">
        {children}
      </main>

      <footer className="bg-gradient-to-r from-indigo-800 to-violet-900 text-white py-8 mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-indigo-200 hover:text-white transition hover-scale"
                  aria-label="Twitter"
                >
                  <svg
                    className="h-6 w-6"
